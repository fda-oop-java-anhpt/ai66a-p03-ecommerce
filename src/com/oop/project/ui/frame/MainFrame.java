...
public class MainFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        customerPanel = createPlaceholderPanel("Customer Management", 
            "Manage customer profiles, search, and view order history");
        itemPanel = createPlaceholderPanel("Item Catalog", 
            "Add, update, and manage product inventory");
        orderPanel = createPlaceholderPanel("Order Management", 
