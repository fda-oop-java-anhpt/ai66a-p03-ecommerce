    ...
    public static DefaultTableCellRenderer rows() {
        return new DefaultTableCellRenderer(){
            public Component getTableCellRendererComponent(JTable t,Object v,boolean sel,boolean foc,int r,int c){
                ...
                if(!sel){l.setBackground(r%2==0?UITheme.BG_CARD:UITheme.BG_ROW_ALT);l.setForeground(UITheme.TEXT_PRIMARY);}
        ...
        return new DefaultTableCellRenderer(){
            public Component getTableCellRendererComponent(JTable t,Object v,boolean sel,boolean foc,int r,int c){
                ...
                if(!sel){
                    ...
                    switch(s){case "PAID":l.setForeground(UITheme.STATUS_PAID);break;case "CANCELLED":l.setForeground(UITheme.STATUS_CANCELLED);break;default:l.setForeground(UITheme.STATUS_PENDING);}
    ...
    public static DefaultTableCellRenderer currency() {
        return new DefaultTableCellRenderer(){
            public Component getTableCellRendererComponent(JTable t,Object v,boolean sel,boolean foc,int r,int c){
                ...
                l.setBorder(new EmptyBorder(0,12,0,16)); return l;
            }
        };
    }
    public static void applyAll(JTable t) {
        UITheme.styleTable(t); DefaultTableCellRenderer r=rows();
